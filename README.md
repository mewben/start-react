# Start-React
---
This is an extension of `create-react-app` added with custom eslint, sass/css modules support, and
webpack configuration removing the long relative imports.
